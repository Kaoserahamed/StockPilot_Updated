    ...
    <main className="mx-auto flex min-h-screen max-w-5xl items-center justify-center p-6">
      <div className="grid w-full overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-[0_24px_60px_-24px_rgba(15,23,42,0.25)] md:grid-cols-2">
        <div className="hidden bg-slate-950 p-8 text-white md:block">
          <div className="flex h-10 w-10 items-center justify-center rounded-2xl bg-gradient-to-br from-emerald-400 to-teal-600 text-xl font-black">
            S
          </div>
          ...
          <p className="mt-3 text-sm leading-relaxed text-slate-300">
            Check today&apos;s sales, finish pending invoices and keep stock accurate — all from one
            calm dashboard.
          </p>
          <div className="mt-6 space-y-2 text-sm">
            {[
              'Live sales & profit overview',
              'Low-stock and dues reminders',
              'One-click invoice PDF downloads',
            ].map((t) => (
        ...
        <div className="p-7">
          ...
          <div className="mt-5 space-y-3.5">
            <Field label="Email or phone">
              <Input value={u} onChange={(e) => setU(e.target.value)} placeholder="you@shop.com" />
            </Field>
