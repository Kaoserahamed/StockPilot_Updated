      ...
      <div className="mx-auto max-w-6xl px-5 pb-16 pt-10">
        <header className="flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            <div className="flex h-10 w-10 items-center justify-center rounded-2xl bg-gradient-to-br from-emerald-400 to-teal-600 text-xl font-black text-white">
              S
            </div>
        ...
        <div className="mt-14 grid items-center gap-10 md:grid-cols-2">
          <div>
            <div className="inline-flex items-center gap-2 rounded-full border border-emerald-200 bg-emerald-50 px-3 py-1 text-xs font-semibold text-emerald-800">
              New · AI demand forecasting included
            </div>
            <h1 className="mt-4 text-4xl font-extrabold leading-[1.05] tracking-tight md:text-5xl">
              Run your shop with calm, clear numbers.
            </h1>
            <p className="mt-4 max-w-md text-[15px] leading-relaxed text-slate-600">
              StockPilot brings sales, stock, suppliers, expenses and insights into one fast
              workspace designed for busy retail counters.
            </p>
            <div className="mt-6 flex flex-wrap gap-2.5">
              ...
              <Link
                href="/dashboard"
                className="rounded-xl border border-slate-200 bg-white px-5 py-3 text-sm font-bold hover:border-emerald-300"
              >
                View live demo
              </Link>
            </div>
            <div className="mt-6 flex gap-6 text-sm">
              <div>
                <div className="text-xl font-extrabold">2 min</div>
                <div className="text-slate-500">to first sale</div>
              </div>
              <div>
                <div className="text-xl font-extrabold">16</div>
                <div className="text-slate-500">workspace screens</div>
              </div>
              <div>
                <div className="text-xl font-extrabold">PDF + CSV</div>
                <div className="text-slate-500">instant exports</div>
              </div>
            </div>
          </div>
          <div className="rounded-3xl border border-slate-200 bg-white p-5 shadow-[0_24px_60px_-24px_rgba(5,150,105,0.35)]">
            <div className="flex items-center justify-between">
              ...
              <div className="rounded-full bg-emerald-100 px-2.5 py-1 text-xs font-bold text-emerald-800">
                Live
              </div>
            </div>
            <div className="mt-4 grid grid-cols-2 gap-3">
              {[
                ['Revenue', '৳ 24,580', '38 orders'],
                ['Net profit', '৳ 6,140', '+18% vs yesterday'],
                ['Low stock', '7 items', '3 need reorder'],
                ['Pending dues', '৳ 3,900', '6 customers'],
              ].map(([a, b, c]) => (
            ...
            <div className="mt-4 rounded-2xl bg-slate-950 p-4 text-white">
              ...
              <div className="mt-1 text-sm">
                Rice 1kg is selling 2.4x faster this week. Reorder 40 units before Friday.
              </div>
            </div>
          </div>
        </div>
